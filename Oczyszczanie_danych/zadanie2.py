...
# Wczytanie kolumn z powrotem do dateframe 
...
bankruptcy[kolumny_bez_brakow] = (bankruptcy[kolumny_bez_brakow] - bankruptcy[kolumny_bez_brakow].min()) / (bankruptcy[kolumny_bez_brakow].max() - bankruptcy[kolumny_bez_brakow].min())
